...
replace_string(f'/home/{user_name}/catkin_ws/src/clover/clover/launch/aruco.launch', '<arg name="aruco_detect"', ' <argname="aruco_detect" default="true"/>')
...
# Настройка запуска Clover. Взято с оф. сайта НТО, нужно еще проверить
...
# Настройка launch файла. Взято с оф. сайта НТО, нужно еще проверить
